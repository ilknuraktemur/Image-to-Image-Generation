...
mkdir -p ./ComfyUI/models/ipadapter && wget "https://huggingface.co/h94/IP-Adapter-FaceID/resolve/main/ip-adapter-faceid_sdxl.bin" -O ./ComfyUI/models/ipadapter/ip-adapter-faceid_sdxl.bin
...
mkdir -p ./ComfyUI/models/loras/ipadapter && wget "https://huggingface.co/h94/IP-Adapter-FaceID/resolve/main/ip-adapter-faceid_sdxl_lora.safetensors" -O ./ComfyUI/models/loras/ipadapter/ip-adapter-faceid_sdxl_lora.safetensors
...
mkdir -p ./ComfyUI/models/instantid &&  wget "https://huggingface.co/InstantX/InstantID/resolve/main/ip-adapter.bin" -O ./ComfyUI/models/instantid/ip-adapter.bin
mkdir -p ./ComfyUI/models/instantid/SDXL && wget "https://huggingface.co/InstantX/InstantID/resolve/main/ip-adapter.bin" -O ./ComfyUI/models/instantid/SDXL/ip-adapter.bin
